<template>
  <div class="slide-toolbar" v-show="visible">
    <button class="st-btn" title="更多操作" @click.stop="$emit('menu', $event.currentTarget?.getBoundingClientRect?.() || null)">
    ...
    <button class="st-btn st-ai" title="AI 修改此页" @click.stop="$emit('ai-enhance')">
